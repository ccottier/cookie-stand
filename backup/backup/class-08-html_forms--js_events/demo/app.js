...
function Item(name, price) {
  ...
  this.price = price;
  this.tax = 0;
  // this.calTax = function () { is same as line above//
...
//every time the button is clicked, this function runs//
...
function handleFormSubmit(event) {
  //everytime a form is submit, the page defaults to reloading, below prevents this from happening//
...
//sets up the function so that JS can envoke the function when the user clicks the button//
